...
3. runs `scripts/glf_closure_guard.py` in strict coherence mode,
...
The certificate is a functoriality super-lane certificate. It records closure of the declared admissible transfer lattice, not just one isolated transfer example.
