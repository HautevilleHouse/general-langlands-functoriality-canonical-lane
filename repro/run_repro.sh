...
mkdir -p .codex_tmp/general_langlands_functoriality
cp artifacts/stitch_constants.json .codex_tmp/general_langlands_functoriality/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/general_langlands_functoriality/constants_registry.json
python3 scripts/glf_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
